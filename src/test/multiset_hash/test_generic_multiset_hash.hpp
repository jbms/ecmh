#ifndef HEADER_GUARD_8344b1c871299f5f2512c9ea184e2e94
#define HEADER_GUARD_8344b1c871299f5f2512c9ea184e2e94
...
template <class MSH>
void test_generic_multiset_hash(MSH const &msh) {
  test_generic_multiset_hash_with_size<10>(msh);
  test_generic_multiset_hash_with_size<100>(msh);
  test_generic_multiset_hash_with_size<150>(msh);
}
}
}
